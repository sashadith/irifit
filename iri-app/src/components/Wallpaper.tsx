 ...
 *
 * Bewusst STATISCH (Entscheidung Sascha 09.08. nach Beta-Test): Der driftende
 * Hintergrund aus S18 war den Preis nicht wert — Bewegung gehört in die
 * Inhalte (Wasser, Ring), nicht in die Bühne.
 */
