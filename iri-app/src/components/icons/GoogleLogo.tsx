...
/** Offizielles Google-„G" in den vier Markenfarben (für OAuth-Buttons) */
export function GoogleLogo({ size = 18 }: { readonly size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      ...
      <Path
        fill="#FBBC05"
        d="M5.84 14.1A6.6 6.6 0 0 1 5.49 12c0-.73.13-1.43.35-2.09V7.07H2.18a11 11 0 0 0 0 9.86l3.66-2.84z"
      />
      <Path
        fill="#EA4335"
