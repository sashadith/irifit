...
const ICONS = {
  ...
  steps: {
    paths: [
      'M8.2 3.6c1.7-.2 2.7 1.1 2.6 3.2-.1 2-1 3.4-2.5 3.4S5.9 8.9 6 6.9c.1-2 .9-3.1 2.2-3.3zM8.4 12.2c1 0 1.6.7 1.5 1.7s-.8 1.6-1.7 1.6-1.5-.7-1.4-1.7c.1-1 .7-1.6 1.6-1.6z',
      'M15.8 9.4c1.5 0 2.4 1.4 2.3 3.4-.1 2-1 3.3-2.6 3.2-1.5-.1-2.3-1.5-2.2-3.5.1-2 1-3.1 2.5-3.1zM15.6 18c.9 0 1.5.6 1.4 1.6-.1.9-.8 1.5-1.7 1.5-.9-.1-1.4-.8-1.3-1.7.1-.9.7-1.4 1.6-1.4z',
    ],
  },
  sparkleDuo: {
    paths: [
